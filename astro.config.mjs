    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: 'Knowledge',
          items: [
            { label: '知识库阅读入口', slug: 'knowledge/overview' },
            { label: 'C++ / Linux 系统工程', slug: 'knowledge/senior-cpp-linux-systems' },
            { label: '交易系统', slug: 'knowledge/senior-trading-systems' },
            { label: '模型部署与量化', slug: 'knowledge/senior-model-deployment-quantization' },
            { label: 'ONNX 深入专题', slug: 'knowledge/senior-onnx-in-depth' },
            { label: 'MLIR 工具链', slug: 'knowledge/mlir' },
            { label: '图优化与性能分析', slug: 'knowledge/graph-optimization' },
            { label: 'NPU 与端侧 AI 加速器', slug: 'knowledge/senior-npu-edge-accelerators' },
            { label: '大模型推理', slug: 'knowledge/llm-inference' },
            { label: 'Agent Memory 架构', slug: 'knowledge/senior-agent-memory-architecture' },
